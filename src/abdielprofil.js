  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center text-white">
      <div className="bg-gray-800 p-8 rounded-xl shadow-lg text-center max-w-md w-full">
          ...
          <img src="/fotoabi.jpeg" alt="foto" className="w-28 h-28 rounded-full border-4 border-indigo-400 shadow-lg mx-auto block"/>
        
         
        

        <h1 className="text-2xl font-bold">
          Abdiel Rayman Carlitos
        </h1>
        ...
        <div className="mt-6 space-y-2 text-sm">
          ...
          <p><span className="font-semibold text-indigo-300">Kampus:</span> Universitas Brawijaya</p>
          <p><span className="font-semibold text-indigo-300">Hobi:</span> Gaming, Reading, Writing</p>
          <p><span className="font-semibold text-indigo-300">Jurusan:</span> Teknik Informasi</p>
